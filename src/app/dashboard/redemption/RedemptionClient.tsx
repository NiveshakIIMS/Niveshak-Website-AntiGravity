...
interface RedemptionClientProps {
    ...
    initialRedeemLink?: string;
}

export default function RedemptionClient({ initialCards = [], initialRedeemLink = "" }: RedemptionClientProps) {
    const [cards, setCards] = useState<RedemptionCard[]>(initialCards);
    const [redeemLink, setRedeemLink] = useState(initialRedeemLink);
